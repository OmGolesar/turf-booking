...
class _TurfListingScreenState extends State<TurfListingScreen> {
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    if (_sortBy == 'Price ↑') {
      list = [...list]..sort((a, b) => (a['price'] as int).compareTo(b['price'] as int));
    } else if (_sortBy == 'Price ↓') {
      list = [...list]..sort((a, b) => (b['price'] as int).compareTo(a['price'] as int));
    } else {
      list = [...list]..sort((a, b) => (b['rating'] as double).compareTo(a['rating'] as double));
    }
    return list;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: turfs.isEmpty
                ? const Center(child: Text('No turfs found'))
                : ListView.separated(
